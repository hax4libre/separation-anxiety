...
# The After Math: January 2026

See how the math shakes out after one year of assault of civil servants. Explore the impact to federal workforce as of January 31, 2026. Use the filters below to drill down into specific agencies, components, occupations, and demographics to compare against current workforce separations and trends.
...
const db = await DuckDBClient.of({ 
  bt: FileAttachment("./data/am_data.parquet") 
});
```
...
## The After Math: Data Dictionary & Processing

This page focuses on record level data from OPM's Enterprise Human Resources Integration (EHRI) Status dataset from January 31, 2026. 
...
## The After Math: Data Dictionary
...
output_file = "after_math.parquet"
...
```
    ...
    Found 1 files to process:
     - employment_202601_1_2026-04-20.txt
...
```
    ...
    Successfully loaded file with 2035344 rows
    
    Total records loaded: 2035344
...
```
    ...
    Number of values nullified: 18711009
    Number of records affected: 1198167
...
```
    ...
    Nullified 0 records with a 1900 service computation date.
...
```
    ...
    Raw Service Range:
      ...
      --> Maximum length of service: 79.3 years
...
```
    ...
    Data successfully cleaned, typed, and exported to after_math.parquet
